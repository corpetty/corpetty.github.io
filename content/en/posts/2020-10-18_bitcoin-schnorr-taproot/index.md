...
### Taproot
Taproot is an improvement on a different technology called `Merkelized Abstract Syntax Tree` or MAST. In short, a MAST allows you to stack Bitcoin scripts into a Merkle tree, expanding the possibile things a Bitcoin txn is capable of doing{{<cite bib="khatwani2020taproot">}}. 
